...
from ...core.validators import validate_allinone_function
...
class BatchRenameGUI(QMainWindow):
    ...
    def create_allinone_config(self):
        ...
        self.allinone_selector = FunctionSelector("all-in-one processing function", 1, validate_allinone_function)
